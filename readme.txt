...
HTML Page (5%):
	Please visit http://karmaqueen.github.io/isom3320/ for our HTML page! 
...
Items:
Max Ammo
	Fills up the magazine with ammo. If reloading, 
	it resets the reload timer and the player can shoot again.
Weapon
	Replaces the current player's gun. If the player picks up the same gun, 
	the ammo is refilled like Max Ammo, but will not reset the reload timer.
Max Health
